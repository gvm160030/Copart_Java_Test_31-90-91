<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CopartWebApp.aspx.cs" Inherits="WebApplicationCopart.CopartWebApp" %>
...
<head runat="server">
    ...
    <title></title>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDBxryB6NE9ANsgVorZ16gsFrq4pZiSEoU&libraries=geometry"></script>
...
<body>
    ...
    <%--<table>  
        ...
        <tr>
                    <td>Customer ID</td>
                    <td>
                        <asp:TextBox ID="txtCustID" runat="server" onblur="getLocation();"></asp:TextBox>
                        
                    </td>
                </tr>
        <tr>
            <td>
         <asp:Button ID="btnSubmit" runat="server" Text="Get nearest location" OnClick="btnSubmit_Click" />
                </td>
            </tr>
            </table>
    --%>
...
<input id="address" type="text" value="94301"></input>
        <br />
<input id="CustID" type="text" value="Enter Customer ID"></input>
